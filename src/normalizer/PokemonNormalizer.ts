...
export const normalizePokemon = async (PokemongenOne: Pokemon): Promise<PokemonFinalObject[]> => {
  try {
    ...
    return normalizedData.filter((pokemon): pokemon is PokemonFinalObject => pokemon !== null);
  } catch (error) {
